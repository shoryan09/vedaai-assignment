    ...
    <>
      ...
      <div className="flex-1 p-4 md:p-8">
        ...
        <div className="mb-5 md:mb-6">
          <h2 className="text-lg md:text-xl font-semibold text-gray-900 mb-1">Assignments</h2>
          <p className="text-sm text-gray-500">Manage and create assignments for your classes.</p>
        </div>

        {/* Toolbar */}
        <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3 mb-5 md:mb-6">
