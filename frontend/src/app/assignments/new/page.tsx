...
export default function NewAssignmentPage() {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file.type === "text/plain" || file.name.endsWith(".txt")) {
      ...
      // For PDFs, just store the name — we'd need pdf-parse on backend for real extraction
      setFileName(file.name);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Subscribe to socket for job updates BEFORE navigating
      getSocket();
  ...
  return (
    <>
      ...
      <div className="flex-1 px-6 md:px-10 py-6 max-w-4xl mx-auto w-full">
        <div className="mb-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-1">Create Assignment</h2>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
          ...
          <div className="mb-5">
            ...
            <label className="flex flex-col items-center justify-center w-full py-8 px-4 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-gray-400 transition bg-gray-50">
          ...
          {questionTypes.map((row, index) => (
            <div key={index} className="grid grid-cols-12 gap-3 mb-3 items-center">
              ...
              <input
                ...
                className="col-span-6 md:col-span-3 px-3 py-2 border border-gray-300 rounded-lg text-sm outline-none focus:border-gray-900"
              />
              <input
                type="number"
                min={1}
                ...
                className="col-span-5 md:col-span-2 px-3 py-2 border border-gray-300 rounded-lg text-sm outline-none focus:border-gray-900"
              />
              <button
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            disabled={submitting}
            className="flex items-center gap-2 px-5 py-2 bg-[#1a1a1a] hover:bg-black text-white text-sm font-medium rounded-lg transition disabled:opacity-50"
          >
